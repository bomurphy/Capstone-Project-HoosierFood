<?php
    require_once('./google-api/vendor/google/apiclient-services/autoload.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="nav-background">
    ...
    <nav class="navbar navbar-expand-lg p-2 border-bottom nav-background">
      ...
      <section class="d-flex align-items-center flex-column hero-section h-100">
        <h2 class="mb-5 title-text red-text">Hoosier Food</h2>
        <!-- sign in btn -->
        ...
        <div class="data">
            ...
            <p>Email</p>
            <p id="email"></p>
            <button class="signOutBtn login hide"><a href='../Login/login.html'>Sign Out</a></button></button>
