...
insert into restaurants(restaurantID, RestaurantName, Street, City, State, Zip, PhoneNum) values (37, 'Chow Bar', '216 S Indiana Avenue', 'Bloomington', 'IN', '47408', '812-336-3888');
insert into restaurants(restaurantID, RestaurantName, Street, City, State, Zip, PhoneNum) values (38, 'Cloverleaf', '325 E Winslow Road', 'Bloomington', 'IN', '47401', '812-650-1017');
insert into restaurants(restaurantID, RestaurantName, Street, City, State, Zip, PhoneNum) values (39, 'Coaches Bar and Grill', '245 N College Avenue', 'Bloomington', 'IN', '47404', '812-331-1335');
insert into restaurants(restaurantID, RestaurantName, Street, City, State, Zip, PhoneNum) values (40, 'Crazy Horse', '214 W Kirkwood Avenue', 'Bloomington', 'IN', '47404', '812-336-8877');
insert into restaurants(restaurantID, RestaurantName, Street, City, State, Zip, PhoneNum) values (41, 'Cresent Doughnut', '231 S Adams Street', 'Bloomington', 'IN', '47404', '812-339-7771');
insert into restaurants(restaurantID, RestaurantName, Street, City, State, Zip, PhoneNum) values (42, 'Crumbl Cookies', '1155 S College Mall Road', 'Bloomington', 'IN', '47401', '812-668-7779');
insert into restaurants(restaurantID, RestaurantName, Street, City, State, Zip, PhoneNum) values (43, 'Culvers', '1914 W Third Street', 'Bloomington', 'IN', '47404', '812-822-1837');
insert into restaurants(restaurantID, RestaurantName, Street, City, State, Zip, PhoneNum) values (44, 'Da Vinci Pizza Pasta', '250 S Washington Street', 'Bloomington', 'IN', '47408', '812-822-1887');
insert into restaurants(restaurantID, RestaurantName, Street, City, State, Zip, PhoneNum) values (45, 'Dagwoods Deli', '116 S Indiana Avenue', 'Bloomington', 'IN', '47408', '812-333-3000');
insert into restaurants(restaurantID, RestaurantName, Street, City, State, Zip, PhoneNum) values (46, 'Dairy Queen', '2423 S Walnut Street', 'Bloomington', 'IN', '47401', '812-334-2423');
insert into restaurants(restaurantID, RestaurantName, Street, City, State, Zip, PhoneNum) values (47, 'Deangelos', '2620 E 3rd Street', 'Bloomington', 'IN', '47401', '812-961-0008');
insert into restaurants(restaurantID, RestaurantName, Street, City, State, Zip, PhoneNum) values (48, 'Dennys', '2160 N Walnut Street', 'Bloomington', 'IN', '47404', '812-336-7694');
insert into restaurants(restaurantID, RestaurantName, Street, City, State, Zip, PhoneNum) values (49, 'Dragon Express', '1400 E 3rd Street', 'Bloomington', 'IN', '47401', '812-331-7030');
insert into restaurants(restaurantID, RestaurantName, Street, City, State, Zip, PhoneNum) values (50, 'Z and C', '430 E Kirkwood Avenue', 'Bloomington', 'IN', '47404', '812-323-8999');
...
insert into menus (restaurantID, RestaurantName, menuURL) values (11, '3 Amigos','https://the3amigosbtowns.com/menu/');
insert into menus (restaurantID, RestaurantName, menuURL) values (12, 'Arbys','https://www.arbys.com/menu/');
insert into menus (restaurantID, RestaurantName, menuURL) values (13, 'Applebees','https://www.applebees.com/en/menu');
insert into menus (restaurantID, RestaurantName, menuURL) values (14, 'Amrit India','https://www.amritbloomington.com/menu.aspx');
insert into menus (restaurantID, RestaurantName, menuURL) values (15, 'Asuka','https://www.asukanoodlestown.com/menu');
insert into menus (restaurantID, RestaurantName, menuURL) values (16, 'Avers Pizza','https://averspizza.com/menu/');
insert into menus (restaurantID, RestaurantName, menuURL) values (17, 'Azzip Pizza','https://order.azzippizza.com/azzippizza-bloomington/menu');
insert into menus (restaurantID, RestaurantName, menuURL) values (18, 'Baked Bloomington','https://www.bakedofbloomington.com/menu.html');
insert into menus (restaurantID, RestaurantName, menuURL) values (19, 'Bedrak Cafe','https://www.bedrakcafe.com/menu');
insert into menus (restaurantID, RestaurantName, menuURL) values (20, 'Big Woods Bloomington','https://www.bigwoodsrestaurants.com/bloomington/');
insert into menus (restaurantID, RestaurantName, menuURL) values (21, 'BJs Restaurant','https://www.bjsrestaurants.com/menu');
insert into menus (restaurantID, RestaurantName, menuURL) values (22, 'Blondies Cookies','https://www.blondiescookies.com/');
insert into menus (restaurantID, RestaurantName, menuURL) values (23, 'Blooming Thai','https://www.bloomingthai.net/menu');
insert into menus (restaurantID, RestaurantName, menuURL) values (24, 'Bloomington Bagel Company','https://bbcbagel.com/');
insert into menus (restaurantID, RestaurantName, menuURL) values (25, 'Bubs Burgers','https://bubsburgers.com/bubs-burgers-menu/');
insert into menus (restaurantID, RestaurantName, menuURL) values (26, 'Buffalo Wild Wings','https://www.buffalowildwings.com/en/food/');
insert into menus (restaurantID, RestaurantName, menuURL) values (27, 'Burger King','https://www.bk.com/menu');
insert into menus (restaurantID, RestaurantName, menuURL) values (28, 'Butchs Grillacatessen & Eatzeria','https://eatbutch.com/menus.php');
insert into menus (restaurantID, RestaurantName, menuURL) values (29, 'C3','https://www.c3bloomington.com/menus');
insert into menus (restaurantID, RestaurantName, menuURL) values (30, 'The Cabin','cabinrestaurant446.com');
insert into menus (restaurantID, RestaurantName, menuURL) values (31, 'Cafe Pizzaria','http://www.cafepizzaria.com/menu/');
insert into menus (restaurantID, RestaurantName, menuURL) values (32, 'Casa Brava','https://www.casabravabloomington.com/menu-lunch-dinner');
insert into menus (restaurantID, RestaurantName, menuURL) values (33, 'Che Bello','https://chebellokitchen.com/menu/');
insert into menus (restaurantID, RestaurantName, menuURL) values (34, 'Cheddars','https://www.cheddars.com/menu/family-bundles/');
insert into menus (restaurantID, RestaurantName, menuURL) values (35, 'Chilis Grill and Bar','https://www.chilis.com/menu');
insert into menus (restaurantID, RestaurantName, menuURL) values (36, 'Chipotle','https://www.chipotle.com/');
insert into menus (restaurantID, RestaurantName, menuURL) values (37, 'Chow Bar','https://btownmenus.com/restaurants/chow-bar-c4355/delivery');
insert into menus (restaurantID, RestaurantName, menuURL) values (38, 'Cloverleaf','https://zmenu.com/cloverleaf-family-restaurant-bloomington-online-menu/');
insert into menus (restaurantID, RestaurantName, menuURL) values (39, 'Coaches Bar and Grill','https://www.restaurantji.com/in/bloomington/coaches-bar-and-grill-/');
insert into menus (restaurantID, RestaurantName, menuURL) values (40, 'Crazy Horse','https://crazyhorseindiana.com/menus/');
insert into menus (restaurantID, RestaurantName, menuURL) values (41, 'Cresent Doughnut','https://www.grubhub.com/restaurant/cresent-donut-shops-231-south-adams-street-bloomington/1891006');
insert into menus (restaurantID, RestaurantName, menuURL) values (42, 'Crumbl Cookies','https://crumblcookies.com/');
insert into menus (restaurantID, RestaurantName, menuURL) values (43, 'Culvers','https://www.culvers.com/menu-and-nutrition');
insert into menus (restaurantID, RestaurantName, menuURL) values (44, 'Da Vinci Pizza Pasta','https://vincipie.com/');
insert into menus (restaurantID, RestaurantName, menuURL) values (45, 'Dagwoods Deli','http://www.dagwoodsandwiches.com/menu.html');
insert into menus (restaurantID, RestaurantName, menuURL) values (46, 'Dairy Queen','https://www.dairyqueen.com/en-us/menu/');
insert into menus (restaurantID, RestaurantName, menuURL) values (47, 'Deangelos','https://www.deangelosbloomington.com/menu');
insert into menus (restaurantID, RestaurantName, menuURL) values (48, 'Dennys','https://www.dennys.com/location/dennys-7563/menu');
insert into menus (restaurantID, RestaurantName, menuURL) values (49, 'Dragon Express','https://www.zomato.com/bloomington-in/dragon-express-llc-bloomington/menu');
insert into menus (restaurantID, RestaurantName, menuURL) values (50, 'Z and C','https://zcteriyakiandsushirestaurant.netwaiter.com/bloomington/#default');
